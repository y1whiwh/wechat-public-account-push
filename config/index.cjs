...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'k_YHTPLYZYeEY-Ia3UM1Kap6CKunlJipKq33v0x6hsI',
      // 所在省份或城市，也可以不填
      province: '哈尔滨',
      // 所在城市或县区
      city: '道外区',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '姜姜', year: '2002', date: '01-04',
        },
  ...
  CALLBACK_TEMPLATE_ID: '	k_YHTPLYZYeEY-Ia3UM1Kap6CKunlJipKq33v0x6hsI',
